...
const navItems: NavItem[] = [
  ...
  { href: "/dashboard/tastings", label: "Dégustations",    icon: <UtensilsCrossed className="w-5 h-5" />, roles: ["admin", "hostess", "manager", "coordinator"] },
  { href: "/dashboard/sales",    label: "Distributions",          icon: <ShoppingCart className="w-5 h-5" />, roles: ["admin", "hostess", "manager", "coordinator"] },
